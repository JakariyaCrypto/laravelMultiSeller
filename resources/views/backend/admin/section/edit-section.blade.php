...
<div class="content mt-3">
    <div class="animated fadeIn">
        <div class="py-3 d-flex justify-content-between align-items-center">
                <div class="header-left"><h5><i class="fa fa-bars"></i> Edit Section</h5></div>
                <div class="header-rith"><a href="{{route('color.index')}}" class="btn btn-success rounded"><i class="fa fa-arrow-left"></i> Back</a></div>
            </div>
                       ...
                       <div class="has-success form-group">
                        ...
                        <div class="has-success form-group">
                            ...
                            <select name="category_id" class="form-control-success form-control">
                                ...
                                @foreach(\App\Models\Category::where('is_parent',0)->orderBy('id','desc')->get() as $cat)
