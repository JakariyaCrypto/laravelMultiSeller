...
@section('title','Admin Currency')
                <div class="header-left"><h5><i class="fa fa-bars"></i> All currency</h5></div>

                <div class="header-rith"><a href="{{route('currency.create')}}" class="btn btn-success btn-sm rounded"><i class="fa fa-plus-circle"></i> Add New</a></div>
            </div>
                            ...
                            <tbody>
                                ...
                                <td>
                                    ...
                                    <td class="d-flex" style="width: 15%">
                                        ...
                                        <a href="{{route('currency.edit',$item->id)}}" data-toggle="tooltip" data-placement="top" title="edit" class="btn btn-sm btn-outline-warning rounded mr-1"><i class="fa fa-edit font-lg"></i></a>
...
$('.del-btn').click(function(e){
    ...
    .then((willDelete) => {
        form.submit();
      if (willDelete) {
        swal("Done! currency Deleted Successfull!", {
          icon: "success",
        });
      } else {
