...
<div class="content mt-3">
    <div class="animated fadeIn">
        <div class="py-3 d-flex justify-content-between align-items-center">
                <div class="header-left"><h5><i class="fa fa-bars"></i> All Brands</h5></div>

                <div class="header-rith"><a href="{{route('brand.create')}}" class="btn btn-success rounded"><i class="fa fa-plus"></i> Add New</a></div>
            </div>
                        ...
                        <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="d-flex">
                                        <a href="{{route('brand.edit',$item->id)}}" data-toggle="tooltip" data-placement="top" title="edit" class="btn btn-sm btn-outline-warning rounded mr-1"><i class="fa fa-edit font-lg"></i></a>
