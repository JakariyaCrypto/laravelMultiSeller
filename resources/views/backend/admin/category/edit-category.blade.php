...
<div class="content mt-3">
    <div class="animated fadeIn">
        <div class="py-3 d-flex justify-content-between align-items-center">
                <div class="header-left"><h5><i class="fa fa-bars"></i> Edit Category</h5></div>
                <div class="header-rith"><a href="{{route('category.index')}}" class="btn btn-success rounded"><i class="fa fa-arrow-left"></i> Back</a></div>
            </div>
            ...
            <div class="col-sm-12">
                ...
                <div class="card-body card-block"> 
                       ...
                       <div class="has-success form-group">
                            <label for="inputIsValid" class=" form-control-label">Category Name <strong class="text-primary"> *</strong></label>
