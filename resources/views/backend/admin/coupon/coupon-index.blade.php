...
<div class="content mt-3">
    <div class="animated fadeIn">
        <div class="py-3 d-flex justify-content-between align-items-center">
                <div class="header-left"><h5><i class="fa fa-bars"></i> All Coupon</h5></div>

                <div class="header-rith"><a href="{{route('coupon.create')}}" class="btn btn-success rounded"><i class="fa fa-plus-circle"></i> Add New</a></div>
            </div>
                            ...
                            <tbody>
                                ...
                                <td>
                                    ...
                                    <td class="d-flex" style="width: 15%">
                                        ...
                                        <a href="{{route('coupon.edit',$item->id)}}" data-toggle="tooltip" data-placement="top" title="edit" class="btn btn-sm btn-outline-warning rounded mr-1"><i class="fa fa-edit font-lg"></i></a>
...
$('.del-btn').click(function(e){
    ...
    .then((willDelete) => {
      if (willDelete) {
        form.submit();
        swal("Done! Coupon Deleted Successfull!", {
          icon: "success",
        });
      } else {
        swal("Coupon is not delete!");
      }
    });
